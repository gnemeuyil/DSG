function [ v1,d1,v2,d2,I] = ScreenEigpairsSignedC2R(A,K)
...
%   Dealing with signed graphs by expending complex eigenvectors into two
%   real vectors each containing real and imaginary part respectively
[v,d]=eigs(A,K,'lm');
d=diag(d);
