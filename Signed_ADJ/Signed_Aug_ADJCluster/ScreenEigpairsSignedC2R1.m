function [ v1,d1,v2,d2,I] = ScreenEigpairsSignedC2R1(A,K)
...
%   Dealing with signed graphs by taking real parts of complex eigenvectors
[v,d]=eigs(A,K,'lm');
d=diag(d);
...
% Take the real parts of complex eigenvectors
Nloc=~loc;
v1(:,Nloc)=real(v1(:,Nloc));
